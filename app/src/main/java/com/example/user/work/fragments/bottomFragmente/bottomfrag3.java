...
import com.example.user.work.adapter.ChatMessageAdapter;
import com.example.user.work.models.ChatMessage;
...
public class bottomfrag3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new ChatMessageAdapter(getActivity().getApplicationContext(), new ArrayList<ChatMessage>());
